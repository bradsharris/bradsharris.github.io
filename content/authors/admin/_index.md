...
organizations:
  - name: PNNL, Richland, WA
    # url: https://liphy.univ-grenoble-alpes.fr/

# Short bio (displayed in user profile at end of posts)
bio: Computational scientist at PNNL, in Richland, WA.
...
social:
  - icon: envelope
    icon_pack: fas
    link: mailto:bradscottharris@gmail.com
  - icon: github
    icon_pack: fab
...
{{< figure src="/img/Fig1.svg" caption="My typical workflow" class="full-width center responsive-figure" >}}
